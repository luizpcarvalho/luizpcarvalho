...
- ⚡ Fun fact: I can cook!
    ...
    .stat {
      font: 600 14px 'Segoe UI', Ubuntu, "Helvetica Neue", Sans-Serif; fill: #99d1ce;
    }
    .stagger {
      opacity: 0;
    ...
    .rank-text {
      font: 800 24px 'Segoe UI', Ubuntu, Sans-Serif; fill: #99d1ce; 
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 91.1046362617046;
      }
    }
    ...
    @keyframes fadeInAnimation {
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Abhishek Naidu's GitHub Stats</text>
    </g>
      </g>
